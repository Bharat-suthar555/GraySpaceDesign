...
export function Services() {
  return (
    <section id="services" className="relative border-b border-line bg-panel/40 py-20 sm:py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="max-w-xl"
        >
          <p className="font-mono text-[12px] uppercase tracking-[0.18em] text-blueprint">Services</p>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10 flex h-full min-h-[430px] flex-col justify-end p-5">
                <p className="font-display text-2xl font-semibold text-blueprint">{service.index}</p>
                <h3 className="mt-3 font-display text-2xl font-medium text-studio">{service.title}</h3>
                <p className="mt-3 text-sm leading-7 text-studio/70">{service.body}</p>
